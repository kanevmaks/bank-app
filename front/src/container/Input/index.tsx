  ...
  switch (type.toLowerCase()) {
    ...
    case "password":
      ...
      handleClick = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        ...
        if (error.result) {
          classList.toggle("form__pass--show");
          classList.toggle("form__pass--hide");
        } else if (!error.result) {
          classList.toggle("form__pass--show-red");
          classList.toggle("form__pass--hide-red");
        }
        ...
        {isPassword && (
          <div
            className={`form__password ${
              error.result ? "form__pass--show" : "form__pass--show-red"
            } `}
